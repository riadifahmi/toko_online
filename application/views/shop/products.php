      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-link float-right text-primary mt-1">
            <a href="<?php $keranjang = 'Cart: ' . $this->cart->total_items() . ' items' ?>"></a>
            <?php echo anchor('products/detail_keranjang', $keranjang) ?>
          </li>
        </ul>
      </div>
    </div>
      ...
      <?php foreach ($barang as $brg) : ?>
        <div class="col-lg-4 col-md-4 all dev">
          <div class="product-item">
            <a href="#"><img src="<?php echo base_url() . '/uploads/' . $brg['gambar'] ?>" width="300"></a>
            <div class="down-content">
              <h4><?= $brg['nama_brg']; ?></h4>
              <h6>Rp. <?php echo number_format ($brg['harga'], 0,',','.'); ?></h6>
              <p><?= $brg['keterangan']; ?></p>
              <a href="<?= base_url(); ?>products/tambah_ke_keranjang/<?= $brg['id_brg']; ?>" class="btn btn-danger">Tambah Ke Keranjang</a>
              <a href="<?= base_url(); ?>products/detail/<?= $brg['id_brg']; ?>" class="btn btn-danger">Detail</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
